...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-200 bg-black/40 backdrop-blur-[6px] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 duration-150 will-change-[opacity]",
      className
    )}
...
>(({ className, children, preventOutsideClose = true, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
